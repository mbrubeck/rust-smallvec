...
#![cfg_attr(feature = "likely", feature(stmt_expr_attributes, core_intrinsics))]
...
#[cfg(feature = "likely")]
macro_rules! likely {
    ($e:expr) => { #[allow(unused_unsafe)] unsafe { core::intrinsics::likely($e) } }
}
...
#[cfg(feature = "likely")]
macro_rules! unlikely {
    ($e:expr) => { #[allow(unused_unsafe)] unsafe { core::intrinsics::unlikely($e) } }
}

#[cfg(not(feature = "likely"))]
macro_rules! assume {
    ($e:expr) => { #[allow(unused_must_use)] { $e } }
}

#[cfg(feature = "likely")]
macro_rules! assume {
    ($e:expr) => { core::intrinsics::assume($e) }
}
